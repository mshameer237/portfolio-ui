...
const HomeAnimation = () => {
  ...
  const [hover, setHover] = useState({ id: null, isHovered: false });

  const onHover = (id) => {
    setHover({ id: id, isHovered: true });
  };

  const onRemoveHover = (id) => {
    setHover({ id: id, isHovered: false });
  };
  return (
    <>
      <svg
      ...
      >
        ...
        <g
          ...
          onMouseLeave={() => onRemoveHover("skills")}
        >
          <path
            ...
            transform="translate(-206.59003 -163.87113)"
            fill="#444"
            stroke={hover.id === "skills" && hover.isHovered ? "#fff" : ""}
            strokeWidth={3}
          />
          <path
        ...
        <motion.path
          animate={{
            x: [-208.59003, -208.59003, -206.59003],
            y: [-163.87113, -166.87113, -163.87113],
          }}
          initial="hidden"
        ...
        <g
          ...
          onMouseLeave={() => onRemoveHover("exp")}
          data-tip="My Experience"
        >
          <motion.path
            animate={{
              opacity: [0, 0.5, 1],
              x: [-206.59003, -206.59003],
              y: [-283.87113, -163.87113],
            }}
            initial="hidden"
            ...
            transform="translate(-206.59003 -163.87113)"
            fill="#444"
            stroke={hover.id === "exp" && hover.isHovered ? "#fff" : ""}
            strokeWidth={3}
          />
          <motion.path
            animate={{
          ...
          <motion.rect
            ...
            initial="hidden"
            transition={{ duration: 0.6, delay: 2.2, repeat: Infinity }}
            x="183.62601"
            y="282.51852"
            width="102.23622"
            height="10.8457"
        ...
        <g id="cofee" data-tip="Just a Cup of Coffee ;)">
          <path
        ...
        <g
          ...
          onMouseEnter={() => onHover("about-me")}
          onMouseLeave={() => onRemoveHover("about-me")}
          data-tip="About Me"
        >
          <path
            ...
            transform="translate(-206.59003 -163.87113)"
            fill="#111"
            stroke={hover.id === "about-me" && hover.isHovered ? "#fff" : ""}
            strokeWidth={3}
          />
          <path
        ...
        <path
          ...
          transform="translate(-206.59003 -160.87113)"
          fill="#566573"
        />
        <path
        ...
        <motion.g
          animate={{
            opacity: [0, 0.1, 1],
            x: [305.59003, 305.59003],
            y: [0, -103.87113],
            scale: 0.54117647,
          }}
          initial="hidden"
          transition={{ duration: 1, delay: 1 }}
          transform="translate(400.59003 -23.87113) scale(0.64117647)"
          id="portfolio"
          data-tip="My Projects"
          style={{ cursor: "pointer" }}
          onClick={() => navigate("/projects")}
          onMouseEnter={() => onHover("projects")}
          onMouseLeave={() => onRemoveHover("projects")}
        >
          <path
            d="M327,233v106c0,9.37402-7.62598,17-17,17h-106c-9.37402,0-17-7.62598-17-17v-106c0-9.37402,7.62598-17,17-17h106c9.37402,0,17,7.62598,17,17Zm-17,121c8.28427,0,15-6.71573,15-15v-53.44094c0-37.31184-30.24722-67.55906-67.55906-67.55906h-53.44094c-8.28427,0-15,6.71573-15,15v106c0,8.28427,6.71573,15,15,15h106Z"
            fill="#444"
            stroke={hover.id === "projects" && hover.isHovered ? "#fff" : ""}
            strokeWidth={3}
          ></path>
          <path
            d="M325.12658,286c0-37.62527-31.80087-58.32329-68.12658-68.12658-46.57288-12.5687-80.6821,12.86459-68.12659,68.12659,8.336,36.69019,50.64836,91.44583,68.12659,58.12657,20-38.12658,68.12658-20.50131,68.12658-58.12658Z"
            fill="#ccc"
          ></path>
          <g>
            <path
              d="M271.11047,259.29219h-34.22061c-.86273,0-1.56471-.70199-1.56471-1.56472s.70199-1.56439,1.56471-1.56439h34.22061c.86273,0,1.56439,.70166,1.56439,1.56439s-.70166,1.56471-1.56439,1.56471Z"
              fill="#3f3d56"
            ></path>
            <path
              d="M271.11047,292.65581h-34.22061c-.86273,0-1.56471-.70199-1.56471-1.56472s.70199-1.56439,1.56471-1.56439h34.22061c.86273,0,1.56439,.70166,1.56439,1.56439s-.70166,1.56471-1.56439,1.56471Z"
              fill="#3f3d56"
            ></path>
            <path
              d="M289.47361,275.98494h-70.94689c-.86273,0-1.56471-.70199-1.56471-1.56472s.70199-1.56439,1.56471-1.56439h70.94689c.86273,0,1.56439,.70166,1.56439,1.56439,0,.86273-.70166,1.56471-1.56439,1.56471Z"
              fill="#3f3d56"
            ></path>
          </g>
        </motion.g>
